...
current_dir = Path(__file__).parent  # pragma: no cover
# static files are mounted for the running app; exclude from test coverage
app.mount("/static", StaticFiles(directory=os.path.join(Path(__file__).parent,
          "static")), name="static")  # pragma: no cover
...
activities = {
    ...
    "Music Ensemble": {
        "description": "Perform with the school orchestra and band",
